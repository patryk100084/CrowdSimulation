...
public class SMPLModifyBones 
{
	...
	public SMPLModifyBones(SkinnedMeshRenderer tr, GameObject go)
    {
        rootObject = go;
		targetRenderer = tr;
    ...
    public bool updateBonePositions(Vector3[] newPositions, bool feetOnGround = false)
    {
        if (! _initialized)
            return false;
	...
	{
        Debug.Log(bonesModified.Length);
		...
		for (int i=0; i<bonesModified.Length; i++)
		{
            ...
            bonesModified[i].parent = rootObject.transform;
		}
		...
		for (int i=0; i<bonesModified.Length; i++)
		{
            ...
            GameObject go = FindObject(parentName);
...
//		Debug.Log("Bind poses: " + bindPoses.Length);
    ...
    private GameObject FindObject(string name)
    {
        ...
        {
            case "m_avg_root" :
                return GameObject.Find(rootObject.name + "/" + name + "_clone");
            case "m_avg_Pelvis" :
                return GameObject.Find(rootObject.name + "/m_avg_root_clone/" + name + "_clone");
            case "m_avg_L_Hip" :
                return GameObject.Find(rootObject.name + "/m_avg_root_clone/m_avg_Pelvis_clone/" + name + "_clone");
            case "m_avg_L_Knee" :
                return GameObject.Find(rootObject.name + "/m_avg_root_clone/m_avg_Pelvis_clone/m_avg_L_Hip_clone/" + name + "_clone");
            case "m_avg_L_Ankle" :
                return GameObject.Find(rootObject.name + "/m_avg_root_clone/m_avg_Pelvis_clone/m_avg_L_Hip_clone/m_avg_L_Knee_clone/" + name + "_clone");
            case "m_avg_R_Hip" :
                return GameObject.Find(rootObject.name + "/m_avg_root_clone/m_avg_Pelvis_clone/" + name + "_clone");
            case "m_avg_R_Knee" :
                return GameObject.Find(rootObject.name + "/m_avg_root_clone/m_avg_Pelvis_clone/m_avg_R_Hip_clone/" + name + "_clone");
            case "m_avg_R_Ankle" :
                return GameObject.Find(rootObject.name + "/m_avg_root_clone/m_avg_Pelvis_clone/m_avg_R_Hip_clone/m_avg_R_Knee_clone/" + name + "_clone");
            case "m_avg_Spine1" :
                return GameObject.Find(rootObject.name + "/m_avg_root_clone/m_avg_Pelvis_clone/" + name + "_clone");
            case "m_avg_Spine2" :
                return GameObject.Find(rootObject.name + "/m_avg_root_clone/m_avg_Pelvis_clone/m_avg_Spine1_clone/" + name + "_clone");
            case "m_avg_Spine3" :
                return GameObject.Find(rootObject.name + "/m_avg_root_clone/m_avg_Pelvis_clone/m_avg_Spine1_clone/m_avg_Spine2_clone/" + name + "_clone");
            case "m_avg_Neck" :
                return GameObject.Find(rootObject.name + "/m_avg_root_clone/m_avg_Pelvis_clone/m_avg_Spine1_clone/m_avg_Spine2_clone/m_avg_Spine3_clone/" + name + "_clone");
            case "m_avg_L_Collar" :
                return GameObject.Find(rootObject.name + "/m_avg_root_clone/m_avg_Pelvis_clone/m_avg_Spine1_clone/m_avg_Spine2_clone/m_avg_Spine3_clone/" + name + "_clone");
            case "m_avg_L_Shoulder" :
                return GameObject.Find(rootObject.name + "/m_avg_root_clone/m_avg_Pelvis_clone/m_avg_Spine1_clone/m_avg_Spine2_clone/m_avg_Spine3_clone/m_avg_L_Collar_clone/" + name + "_clone");
            case "m_avg_L_Elbow" :
                return GameObject.Find(rootObject.name + "/m_avg_root_clone/m_avg_Pelvis_clone/m_avg_Spine1_clone/m_avg_Spine2_clone/m_avg_Spine3_clone/m_avg_L_Collar_clone/m_avg_L_Shoulder_clone/" + name + "_clone");
            case "m_avg_L_Wrist" :
                return GameObject.Find(rootObject.name + "/m_avg_root_clone/m_avg_Pelvis_clone/m_avg_Spine1_clone/m_avg_Spine2_clone/m_avg_Spine3_clone/m_avg_L_Collar_clone/m_avg_L_Shoulder_clone/m_avg_L_Elbow_clone/" + name + "_clone");
            case "m_avg_R_Collar" :
                return GameObject.Find(rootObject.name + "/m_avg_root_clone/m_avg_Pelvis_clone/m_avg_Spine1_clone/m_avg_Spine2_clone/m_avg_Spine3_clone/" + name + "_clone");
            case "m_avg_R_Shoulder" :
                return GameObject.Find(rootObject.name + "/m_avg_root_clone/m_avg_Pelvis_clone/m_avg_Spine1_clone/m_avg_Spine2_clone/m_avg_Spine3_clone/m_avg_R_Collar_clone/" + name + "_clone");
            case "m_avg_R_Elbow" :
                return GameObject.Find(rootObject.name + "/m_avg_root_clone/m_avg_Pelvis_clone/m_avg_Spine1_clone/m_avg_Spine2_clone/m_avg_Spine3_clone/m_avg_R_Collar_clone/m_avg_R_Shoulder_clone/" + name + "_clone");
            case "m_avg_R_Wrist" :
                return GameObject.Find(rootObject.name + "/m_avg_root_clone/m_avg_Pelvis_clone/m_avg_Spine1_clone/m_avg_Spine2_clone/m_avg_Spine3_clone/m_avg_R_Collar_clone/m_avg_R_Shoulder_clone/m_avg_R_Elbow_clone/" + name + "_clone");

             case "f_avg_root" :
                return GameObject.Find(rootObject.name + "/" + name + "_clone");
            case "f_avg_Pelvis" :
                return GameObject.Find(rootObject.name + "/f_avg_root_clone/" + name + "_clone");
            case "f_avg_L_Hip" :
                return GameObject.Find(rootObject.name + "/f_avg_root_clone/f_avg_Pelvis_clone/" + name + "_clone");
            case "f_avg_L_Knee" :
                return GameObject.Find(rootObject.name + "/f_avg_root_clone/f_avg_Pelvis_clone/f_avg_L_Hip_clone/" + name + "_clone");
            case "f_avg_L_Ankle" :
                return GameObject.Find(rootObject.name + "/f_avg_root_clone/f_avg_Pelvis_clone/f_avg_L_Hip_clone/f_avg_L_Knee_clone/" + name + "_clone");
            case "f_avg_R_Hip" :
                return GameObject.Find(rootObject.name + "/f_avg_root_clone/f_avg_Pelvis_clone/" + name + "_clone");
            case "f_avg_R_Knee" :
                return GameObject.Find(rootObject.name + "/f_avg_root_clone/f_avg_Pelvis_clone/f_avg_R_Hip_clone/" + name + "_clone");
            case "f_avg_R_Ankle" :
                return GameObject.Find(rootObject.name + "/f_avg_root_clone/f_avg_Pelvis_clone/f_avg_R_Hip_clone/f_avg_R_Knee_clone/" + name + "_clone");
            case "f_avg_Spine1" :
                return GameObject.Find(rootObject.name + "/f_avg_root_clone/f_avg_Pelvis_clone/" + name + "_clone");
            case "f_avg_Spine2" :
                return GameObject.Find(rootObject.name + "/f_avg_root_clone/f_avg_Pelvis_clone/f_avg_Spine1_clone/" + name + "_clone");
            case "f_avg_Spine3" :
                return GameObject.Find(rootObject.name + "/f_avg_root_clone/f_avg_Pelvis_clone/f_avg_Spine1_clone/f_avg_Spine2_clone/" + name + "_clone");
            case "f_avg_Neck" :
                return GameObject.Find(rootObject.name + "/f_avg_root_clone/f_avg_Pelvis_clone/f_avg_Spine1_clone/f_avg_Spine2_clone/f_avg_Spine3_clone/" + name + "_clone");
            case "f_avg_L_Collar" :
                return GameObject.Find(rootObject.name + "/f_avg_root_clone/f_avg_Pelvis_clone/f_avg_Spine1_clone/f_avg_Spine2_clone/f_avg_Spine3_clone/" + name + "_clone");
            case "f_avg_L_Shoulder" :
                return GameObject.Find(rootObject.name + "/f_avg_root_clone/f_avg_Pelvis_clone/f_avg_Spine1_clone/f_avg_Spine2_clone/f_avg_Spine3_clone/f_avg_L_Collar_clone/" + name + "_clone");
            case "f_avg_L_Elbow" :
                return GameObject.Find(rootObject.name + "/f_avg_root_clone/f_avg_Pelvis_clone/f_avg_Spine1_clone/f_avg_Spine2_clone/f_avg_Spine3_clone/f_avg_L_Collar_clone/f_avg_L_Shoulder_clone/" + name + "_clone");
            case "f_avg_L_Wrist" :
                return GameObject.Find(rootObject.name + "/f_avg_root_clone/f_avg_Pelvis_clone/f_avg_Spine1_clone/f_avg_Spine2_clone/f_avg_Spine3_clone/f_avg_L_Collar_clone/f_avg_L_Shoulder_clone/f_avg_L_Elbow_clone/" + name + "_clone");
            case "f_avg_R_Collar" :
                return GameObject.Find(rootObject.name + "/f_avg_root_clone/f_avg_Pelvis_clone/f_avg_Spine1_clone/f_avg_Spine2_clone/f_avg_Spine3_clone/" + name + "_clone");
            case "f_avg_R_Shoulder" :
                return GameObject.Find(rootObject.name + "/f_avg_root_clone/f_avg_Pelvis_clone/f_avg_Spine1_clone/f_avg_Spine2_clone/f_avg_Spine3_clone/f_avg_R_Collar_clone/" + name + "_clone");
            case "f_avg_R_Elbow" :
                return GameObject.Find(rootObject.name + "/f_avg_root_clone/f_avg_Pelvis_clone/f_avg_Spine1_clone/f_avg_Spine2_clone/f_avg_Spine3_clone/f_avg_R_Collar_clone/f_avg_R_Shoulder_clone/" + name + "_clone");
            case "f_avg_R_Wrist" :
                return GameObject.Find(rootObject.name + "/f_avg_root_clone/f_avg_Pelvis_clone/f_avg_Spine1_clone/f_avg_Spine2_clone/f_avg_Spine3_clone/f_avg_R_Collar_clone/f_avg_R_Shoulder_clone/f_avg_R_Elbow_clone/" + name + "_clone");
            
            default:
                return GameObject.Find(rootObject.name + "_clone");
        }
    }
